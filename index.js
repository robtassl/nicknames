class nicknames {
  ...
  static get(name) {
    ...
    if (name) {
      name = name.toLowerCase()
      result = nicknames.retreiveRows(names, name)
    }
...
const names = [
  ...
  ['ben','benjamin','bennie'],
  ['benedict','bennie','ben'],
  ['benjamin','benjy','jamie','bennie','ben'],
  ['benjy','benjamin'],
  ...
  ['jacquelynne','jacque','jacqui','jacquelyn'],
  ...
  ['madeline','maggie','lena','magda','maddy','madge'],
  ...
  ['patsy','patty'],
  ['patty','patricia'],
  ['paul','polly','paula','pauline'],
  ['paula','polly','lina'],
  ['paulina','polly','lina'],
  ['pauline','polly'],
  ['peg','peggy'],
  ['pelegrine','perry'],
  ['penelope','penny','pennie'],
  ['penelope','penny'],
  ['percival','percy'],
  ['peregrine','perry'],
  ...
  ['william','willy','bell','bela','bill','will','billy','willie'],
  ['willie','william','fred'],
  ['willis','willy','bill'],
